...
('development_progress', 42, 'percentage', 'current'),
('monthly_growth', 18.5, 'percentage', 'current_month'),
('partner_engagement', 85, 'percentage', 'current_month'),
('technical_milestone_completion', 78, 'percentage', 'current_phase'),
('user_retention_rate', 67, 'percentage', 'last_30_days');
...
-- Create policies (these can be adjusted based on your auth requirements)
